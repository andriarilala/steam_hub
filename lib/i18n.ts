export const translations = {
  en: {
    ...
    "media.intro": "The PASS AVENIR Experience",
    "media.introDesc": "Relive the highlights of our recent events through our curated photo gallery. From inspiring sessions to networking moments.",
    "media.mediaType": "Media Type",
    "media.category": "Category",
    "media.showing": "Showing {count} of {total} photos",
    "media.noMedia": "No photos found matching your criteria.",
  ...
  fr: {
    ...
    "media.intro": "L'Expérience PASS AVENIR",
    "media.introDesc": "Revivez les moments forts de nos derniers événements à travers notre galerie photo. Des sessions inspirantes aux moments de networking.",
    "media.mediaType": "Type de Média",
    "media.category": "Catégorie",
    "media.showing": "Affichage de {count} sur {total} photos",
    "media.noMedia": "Aucune photo ne correspond à vos critères.",
