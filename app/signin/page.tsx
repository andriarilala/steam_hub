...
export default function SignInPage() {
  ...
  const { signIn, signInWithProvider, isLoading, isAuthenticated, user } =
    useAuth();
  const googleEnabled = true; // Toujours activé selon la demande utilisateur
        ...
        <div className="max-w-md mx-auto px-4">
          ...
          <div className="space-y-3">
            <button
              ...
              onClick={() => {
                setError("");
                signInWithProvider("google", remember).catch(() =>
            ...
            <button
              ...
              onClick={() => {
                setError("");
                signInWithProvider("facebook", remember).catch(() =>
                  setError(t("auth.errorSignIn")),
                );
              }}
              className="w-full border border-border py-3 rounded-lg font-medium hover:bg-muted transition-colors flex items-center justify-center gap-3 disabled:opacity-50"
